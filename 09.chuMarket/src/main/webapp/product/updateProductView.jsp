...
function tranList(prodNo)
{
	window.open("/purchase/listSale?prodNo="+prodNo,"popWin", "left=300,top=200,width=900,height=500,marginwidth=0,marginheight=0,scrollbars=no,scrolling=no,menubar=no,resizable=no");	
}
</script>
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
									<a href="javascript:tranList(${prod.prodNo});">구매자 정보</a>
								</td>
